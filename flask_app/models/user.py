...
class User:
    ...
    def create_user(cls, data):
        query = "INSERT INTO users (first_name, last_name, email, password,age,height,weight) VALUES ( %(first_name)s, %(last_name)s,%(email)s,%(password)s,%(age)s,%(height)s,%(weight)s);"
